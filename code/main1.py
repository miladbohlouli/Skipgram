...
load = True
saving_path = "dictionary1.pickle"

part1 = doc2vec(name="200-8",
                model_dir="models")

model = part1.model
pickle.dump(model, open("word2vec(model).pickle", 'wb'))
...
#                       window_size=5)
#
#     train_vecs = part1.doc2vec_first_method(train_data)
#
...
#
#     test_vecs = part1.doc2vec_first_method(test_data)
